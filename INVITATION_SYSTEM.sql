...
-- 3. Add tier system to profiles table
...
-- Admins can see all codes (you'll need to manually set is_admin flag)
...
-- 9. Add is_admin flag to profiles (for admin users)
ALTER TABLE profiles
ADD COLUMN IF NOT EXISTS is_admin boolean default false;

-- 10. Create function to validate invitation code
...
-- 11. Create function to use invitation code
...
-- 12. Create function to reset monthly usage (run via cron or manually)
...
-- 13. Insert some initial invitation codes for beta testing
...
-- 14. Make yourself an admin (replace with your actual user ID from auth.users)
...
-- 2. Find your user ID and make yourself admin (step 14)
-- 3. Update the React app with invitation code validation
-- ============================================
